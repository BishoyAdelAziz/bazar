        ...
        images.map(async (image) => {
          if (image) {
            ...
            const storageRef = ref(
              storage,
              `product-images/${productId}/${uniqueFileName}`
            );
        ...
        {isUserLoggedIn ? (
          <>
            <div className="title">
              ...
              <p>
                الرجاء قراءة محتوى{" "}
                <Link to={"/SellerGuidance"}>الصفحة الارشادية للبيع</Link> قبل
                محاولة بيعك على موقعنا
              </p>
            </div>
            ...
            <div className="forms">
                ...
                <div>
                  ...
                  <div className="inp">
                    ...
                    >
                      ...
                      <option value="جديد - بحالة جيدة">
                        جديد و بحالة جيدة
                      </option>
                      <option value="مستعمل - بحالة جيدة">
                        مستعمل - بحالة جيدة
                      </option>
                      <option value="مستعمل - به مشكلة">
                        مستعمل - به مشكلة
                      </option>
              ...
              <div className="productImagesForm">
                <div className="title">
                  ...
                  <p>
                    من المهم ان تكون الصور واضحة - الصورة الاولى هي التي ستكون
                    في الوجاهة
                  </p>
                </div>
                ...
                <div className="images">
                  {[1, 2, 3, 4].map((index) => (
                    <div
                      ...
                      style={{
                        backgroundColor: images[index - 1]
                          ? "transparent"
                          : "#e7e7e7",
            ...
            <div className="notifications">
              <div className="noti success disNone" ref={successNoti}>
                <img
                  src={require("../Images/icons/correct.png")}
                  alt="check-mark"
                />
              ...
              <div className="noti noImg disNone" ref={noImageNoti}>
                <img src={require("../Images/icons/x.png")} alt="x" />
          ...
          <div className="addProduct-noUser">
            <div className="container">
              ...
              <Link to={"/Login"}>
                <button className="btn">سجل دخول من هنا</button>
              </Link>
            </div>
          </div>
        )}
