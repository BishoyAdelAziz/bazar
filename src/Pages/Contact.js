...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_vqj7zqn", "template_l28dja2", form.current, {
      ...
      <div className="contact">
        ...
        <div className="contactDetails">
          <div className="title">
            <h2>ارسل رسالتك</h2>
            <p>
              نرجوا ان يكون محتوى الرسالة واضحا لكي نقوم بالرد عليك باسرع وقت
              ممكن
            </p>
          </div>
          ...
          <div className="container">
            ...
            <div className="socials">
              ...
              <div>
                <img
                  src={require("../Images/icons/instagram-black.png")}
                  alt="instagram-icon"
                />
                <p>@bazaracc</p>
              </div>
